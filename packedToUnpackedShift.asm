; THIS ASSEMBLY CODE CONVERTS PACKED BCD NUMBER TO UNPACKED BCD NUMBER USING SHIFT INSTRUCTION.
...
CODE SEGMENT						; A SEGMENT NAMED AS CODE
    ...
    NEXT:
	    ...
	    SHL AX , 4					; SHIFT LEFT AX REGISTER BY 4 BIT.
   	    SHR AL , 4					; SHIFT RIGHT AL REGISTER BY 4 BIT.
