; THIS ASSEMBLY CODE CONVERTS UNPACKED BCD NUMBER TO PACKED BCD NUMBER USING SHIFT INSTRUCTION.
...
CODE SEGMENT				        ; A SEGMENT NAMED AS CODE
    ...
    NEXT:
	       ...
	       SHL AL , 4			    ; SHIFT LEFT AL REGISTER BY 4 BIT.
           SHR AX , 4			    ; SHIFT RIGHT AX REGISTER BY 4 BIT.
